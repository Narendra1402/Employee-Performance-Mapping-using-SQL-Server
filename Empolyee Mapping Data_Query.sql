...
9. Write a query to calculate the minimum and the maximum salary of the employees in each role. Take data 
...
16. Write a query to calculate the bonus for all the employees, based on their ratings and salaries (Use the 
...
17.Write a query to display employee names along with the names of the projects they are assigned to.
...
Q18: .List employees,those who are not assigned to any project.
...
Q19.List employee names, their project names, and their managers' names.
...
LEFT JOIN employeeRecord m
 ...
 Q20.Show employees who manage others but also report to another manager.
...
WHERE m.MANAGER_ID IS NOT NULL;
 ...
 Q21.List projects that have only one employee assigned.
...
Q22 Find top 3 highest paid employees per department
